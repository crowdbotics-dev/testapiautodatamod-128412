...
## Project Structure
    ...
    ├── testapiautodatamod_128412  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_128412`
...
2. Clone this repo and `cd testapiautodatamod_128412`
